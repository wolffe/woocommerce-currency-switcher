...
class SwitcherWidget extends \WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( isset( $instance['style'] ) && in_array( $instance['style'], [ 'style_01', 'style_02', 'style_03', 'style_04' ] ) ) {
        ...
        $variables['default_text']          = apply_filters( 'wccs_change_default_text', '(Default)' );
